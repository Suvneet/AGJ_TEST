...
public class RestClient {
	...
	//3. Post method with headers
		public CloseableHttpResponse post(String url, HashMap <String, String> headerMap) throws ClientProtocolException, IOException, JSONException {
			CloseableHttpClient  httpClient = HttpClients.createDefault();   //make client connection
		...
		public CloseableHttpResponse post(String url, String userJsonString, HashMap<String, String> hashmap) {
